				...
				<tr>
					...
					<td>
						<button class="btn edit"
							onclick="editProduct(<%=resultSet.getInt("id")%>);">Edit</button>
						<button class="btn delete"
							onclick="deleteProduct(<%=resultSet.getInt("id")%>);">Delete</button>
							<button class="btn" onclick="addMore()">Add More</button>
